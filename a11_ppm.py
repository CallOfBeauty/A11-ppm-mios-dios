...
def main():
    ...
    ppmobject2 = PPM(wn, filename)
    ppmobject2.PPM_grayscale()
    ppmobject2.PPM_display()

    ppmobject3 = PPM(wn, filename)
    ppmobject3.PPM_flip_horizontal()
    ppmobject3.PPM_display()

    ppmobject4 = PPM(wn, filename)
    ppmobject4.PPM_rotateclockwise()
    ppmobject4.PPM_display()

    ppmobject5 = PPM(wn, filename)
    ppmobject5.PPM_make_blue()
